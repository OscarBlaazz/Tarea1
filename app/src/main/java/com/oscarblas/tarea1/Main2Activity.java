...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                serviceWebUltra(fecha.getText().toString());
            }
        });
        ...
        botonVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iniciarOtra;
                iniciarOtra = new Intent(Main2Activity.this, MainInicio.class);
                startActivity(iniciarOtra);
                finish();
            }
        });
        gauge = (Gauge) findViewById(R.id.gauge2);
    }
    private void serviceWebUltra(final String fecha){
        String WS_URL = " http://arrau.chillan.ubiobio.cl:8075/ubbiot/web/mediciones/medicionespordia/"+acceso+"/"+ultra+"/"+fecha;
    ...
    public void readJson2(JSONObject objson) throws JSONException {
